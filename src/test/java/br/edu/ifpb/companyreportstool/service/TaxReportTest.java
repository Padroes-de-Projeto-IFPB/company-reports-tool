...
//    private TaxReport expenseReport;
    ...
    @Test
    public void generateHTMLReportTest(@Autowired TaxReportServiceHtml taxReportServiceHtml) {
        String report = taxReportServiceHtml.generateReport();
    ...
    @Test
    public void generateJsonReportTest(@Autowired TaxReportServiceJson taxReportServiceJson) {
        String report = taxReportServiceJson.generateReport();
