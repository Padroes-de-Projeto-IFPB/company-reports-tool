...
//    private ExpenseReportService expenseReport;
    ...
    @Test
    public void generateHTMLReportTest(@Autowired ExpenseReportServiceHtml expenseReportServiceHtml) {
        String report = expenseReportServiceHtml.generateReport();
    ...
    @Test
    public void generateJsonReportTest(@Autowired ExpenseReportServiceJson expenseReportServiceJson) {
        String report = expenseReportServiceJson.generateReport();
